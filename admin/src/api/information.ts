...
// 地图列表
export function mapsLists(params?: any) {
  return request.get({ url: "/information/maps/list", params });
}

// 添加地图
export function mapsAdd(params: any) {
  return request.post({ url: "/information/maps/add", params });
}

// 编辑地图
export function mapsEdit(params: any) {
  return request.post({ url: "/information/maps/edit", params });
}

// 删除地图
export function mapsDelete(params: any) {
  return request.post({ url: "/information/maps/del", params });
}

// 地图详情
export function mapsDetail(params: any) {
  return request.get({ url: "/information/maps/detail", params });
}
